...
import Image_Artikel1 from '../assets/Artikel_Full1.png';
import Image_Artikel2 from '../assets/Artikel_Full2.png';
import Image_Artikel3 from '../assets/Artikel_Full3.png';
import Image_Artikel4 from '../assets/Artikel_Full4.png';
import Image_Artikel5 from '../assets/Artikel_Full5.png';
import Image_Artikel6 from '../assets/Artikel_Full6.png';
          ...
          <div className="article-container">
            <div className="article-item">
              ...
              <div className="article-content">
                ...
                <Link to="/artikel_full1" className="learn_more_btn">Learn More</Link>
              </div>
            </div>
            <div className="article-item">
              ...
              <div className="article-content">
                ...
                <Link to="#" className="learn_more_btn">Learn More</Link>
              </div>
            </div>
            <div className="article-item">
